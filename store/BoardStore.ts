...
interface BoardState {
    ...
    deleteTodoTask:(taskIndex: number, todo: Todo, id: TypedColumn) => void
...
export const useBoardStore = create<BoardState>((set, get) => ({
 ...
 image: null,
  ...
  deleteTodoTask:async (taskIndex:number, todo: Todo, id: TypedColumn) => {
    let newColumns = new Map(get().board.columns);
